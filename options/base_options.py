...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='sunnytonightnce53', help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--easy_label', type=str, default='experiment_name', help='Interpretable name')
        parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        parser.add_argument('--checkpoints_dir', type=str, default='/media/dataset1/sunnytonightnce53/', help='models are saved here')
        # model parameters
        ...
        #JB_EDIT CUSTOM OPTION
        parser.add_argument('--use_box',
                            help="if you want to use box, please turn on this flag",
                            default=True,
                            action="store_true")
        parser.add_argument('--num_box',
                            default=20, type=int,
                            help='max box num')
        parser.add_argument('--high_res',
                            help='high resolution image 384 (default size:256)',
                            default=True,
                            action='store_true')
        parser.add_argument('--only_patch', action='store_true', help='only use image patch during test time.') # using test time

        self.initialized = True
        # SH add
        parser.add_argument('--nce_inst',
                            action="store_true",
                            default=True,
                            help='max box num')

        parser.add_argument('--use_adain',
                            action="store_true",
                            default=True,
                            help='instance adain transformer generator')
